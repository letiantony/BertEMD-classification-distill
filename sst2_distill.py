...
if __name__ == "__main__":
    ...
    parser.add_argument("--teacher_pretrained_path", default="/home/machunping/knowledge-distill/experiments/sst2/data", type=str,
    ...
    # Prepare random data
    tokenizer = BertTokenizer.from_pretrained("/home/machunping/bert_uncased_torch")
    ...
    #print("teacher model result:")
    #predict(teacher_model, test_dataset, 0, device)
    ...
    train_config = TrainingConfig(device=device, output_dir="saved_models_tmp")
    ...
    # testing
    print("student model result:")
    predict(student_model, test_dataset, 0, device)
    torch.save(student_model,args.output_dir)
