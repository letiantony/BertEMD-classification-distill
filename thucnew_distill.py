...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default='thucnew_saved_model_big', type=str, help="")
    ...
    # Prepare random data
    tokenizer = BertTokenizer.from_pretrained("/home/machunping/bert_chinese")
    ...
    train_config = TrainingConfig(device=device, output_dir=args.output_dir, ckpt_frequency=5, ckpt_epoch_frequency=5)
